...
import top.fifthlight.blazerod.render.api.animation.MaskableAnimationItemInstance
    ...
    class LiveSwitched private constructor(
        ...
        private fun getBaseState(
            ...
            return when {
                ...
                renderState.pose == Pose.SWIMMING -> if (renderState.walkAnimationSpeed > .01) {
                    PlayState.Crawling
                } else {
                    PlayState.CrawlIdle
                }
                ...
                renderState.pose == Pose.CROUCHING -> if (renderState.walkAnimationSpeed > .01) {
                    PlayState.Sneaking
                } else {
                    PlayState.SneakIdle
                }
                ...
                renderState.walkAnimationSpeed > .01 -> PlayState.Walking
                else -> PlayState.Idle
            }
        }
